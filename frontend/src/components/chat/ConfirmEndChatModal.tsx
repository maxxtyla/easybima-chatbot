...
export function ConfirmEndChatModal({ onConfirm, onCancel, isEnding }: ConfirmEndChatModalProps) {
  return (
    <div
    ...
    >
      <div className="w-[85%] max-w-xs bg-cic-white rounded-xl shadow-xl p-5 animate-slide-up">
        ...
        <p id="end-chat-description" className="text-sm text-neutral-600 mb-4">
